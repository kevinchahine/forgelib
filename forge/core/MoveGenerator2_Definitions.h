...
namespace forge
{
	...
	bool MoveGenerator2::isPinPossible() const
	{
		...
		// ex:
		//	If DIRECTION_T is Up, then extends marks all the squares above the King.
		//	If DIRECTION_T is Diagonal, then extends marks all the squares diagonal from the King.
